// Specifies the version of the protocol buffers language we're using.
...
type GetUserRequest struct {
	...
	// The '1' is the field number, used for binary encoding.
...
const file_proto_user_proto_rawDesc = "" +
	...
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB\x14Z\x12task_service/protob\x06proto3"
